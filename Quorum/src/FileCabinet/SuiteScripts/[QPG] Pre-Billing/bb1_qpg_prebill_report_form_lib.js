 ...
 * Server-only library that builds the Pre-Billing Suitelet form. Kept
 * separate from bb1_qpg_prebill_report_lib_helper.js since it uses the
 ...
 */
define(['N/ui/serverWidget', './bb1_qpg_prebill_report_lib_helper'],
    /**
    ...
    (serverWidget, helperLib) => {
        ...
        // Builds the Pre-Billing Suitelet form
        LIB_FX.buildForm = () => {
            const form = serverWidget.createForm({title: 'Pre-Billing'});

            // Cascading filters (Building -> Block -> Floor -> Unit) are handled in the client script
            form.clientScriptModulePath = './bb1_qpg_prebill_report_cs.js';
