 ...
 * Server-only library that builds the Customer Statement Suitelet form. Kept
 * separate from bb1_qpg_cstmt_report_lib_helper.js since it uses the
 ...
 */
define(['N/ui/serverWidget', './bb1_qpg_cstmt_report_lib_helper'],
    /**
    ...
    (serverWidget, helperLib) => {
        ...
        LIB_FX.buildForm = () => {
            ...
            form.clientScriptModulePath = './bb1_qpg_cstmt_report_cs.js';
            ...
            // Sourced from NetSuite's native accounting period record - the
            // standard way to pick a specific month/period on a financial
            // report/statement.
            form.addField({
                id: _FIELDS.FORM.FOR_MONTH,
